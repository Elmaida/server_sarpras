                    ...
                    <div class="card-body">
                        ...
                        <div class = "mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="status_transaksi"  value="<?= $status_transaksi ?>" placeholder="Masukkan Status Transaksi">
                            </div>
                            <div class="mb-3">
                                <label for="status_pengajuan" class="form-label">Status Pengajuan</label>
                                <input type="text" class="form-control" name="status_pengajuan"  value="<?= $status_pengajuan ?>" placeholder="Masukkan Status Pengajuan">
                            </div>
